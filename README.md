...
<details>
<summary><b>Alternative: Manual / Portable Setup</b> (Click to expand)</summary>

If you prefer not to use install scripts or systemd, you can run everything manually. `jwg` manages the *configuration logic*, but you need to run the interface process.
...
```bash
jwg -add phone
# If using portable mode, run: ./jwg -add phone
```
...
xbps-install linux-lts-headers amnezia-dkms jwg
